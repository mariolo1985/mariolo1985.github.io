...
BODY {
					...
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 600px" borderColor="buttontext" border="1">
						...
						<tbody vAlign="top">
							<tr>
								<td style="BACKGROUND-COLOR: transparent">
									<div align="center">
										<font color="#ffffff" size="2" face="Calibri">
											<strong><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #002060" type="button" value="Core Information" xd:xctname="Button" xd:CtrlId="btn_CoreInfoView" tabIndex="0"/>
											</strong>
										</font>
									</div>
								</td>
								<td>
									<div>
										<font size="2" face="Calibri"><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #0070c0" type="button" value="Related Documents" xd:xctname="Button" xd:CtrlId="btn_RelatedDocumentView" tabIndex="0">
								...
								<td>
									<div>
										<font size="2" face="Calibri"><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #002060" type="button" value="Related Notes" xd:xctname="Button" xd:CtrlId="btn_RelatedNotesView" tabIndex="0"/>
										</font>
									</div>
								</td>
								<td style="PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px; BORDER-LEFT-COLOR: ">
									<div>
										<font size="2" face="Calibri"><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #002060" type="button" value="Upload Materials" xd:xctname="Button" xd:CtrlId="btn_MaterialsView" tabIndex="0"/>
										</font>
									</div>
								</td>
							</tr>
											...
											<tbody vAlign="top">
												<tr>
													...
													<td style="BORDER-TOP-COLOR: ; BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div>
															<font size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL3" xd:binding="my:FormInternal/my:LifecycleStatus" xd:disableEditing="yes" style="BORDER-TOP: #dcdcdc 1pt; BORDER-RIGHT: #dcdcdc 1pt; WHITE-SPACE: nowrap; BORDER-BOTTOM: #dcdcdc 1pt; TEXT-ALIGN: right; BORDER-LEFT: #dcdcdc 1pt; WIDTH: 100%; BACKGROUND-COLOR: transparent">
												...
												<tr>
													...
													<td style="BORDER-TOP-COLOR: ; BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div>
															<font size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL30" xd:binding="my:SystemInternal/my:FormName" xd:disableEditing="yes" style="BORDER-TOP: #dcdcdc 1pt; BORDER-RIGHT: #dcdcdc 1pt; WHITE-SPACE: nowrap; BORDER-BOTTOM: #dcdcdc 1pt; TEXT-ALIGN: right; BORDER-LEFT: #dcdcdc 1pt; WIDTH: 100%; BACKGROUND-COLOR: transparent">
										...
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 697px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												...
												<tr>
													...
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font style="BACKGROUND-COLOR: #e9edf1" size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL1" xd:binding="my:Core/my:RequestTitle" xd:disableEditing="yes" xd:datafmt="&quot;string&quot;,&quot;plainMultiline&quot;" style="WORD-WRAP: break-word; WHITE-SPACE: normal; OVERFLOW-X: auto; OVERFLOW-Y: auto; WIDTH: 100%">
																	<xsl:choose>
												...
												<tr>
													...
													<td style="PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font style="BACKGROUND-COLOR: #e9edf1" size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL13" xd:binding="my:Core/my:RequestType" xd:disableEditing="yes" style="WHITE-SPACE: nowrap; WIDTH: 342px">
												...
												<tr>
													<td colSpan="2" style="BORDER-TOP-COLOR: ; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 0px; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 0px">
														<div><xsl:apply-templates select="my:Core/my:PlannedTrainingSection" mode="_5"/>
														</div>
													</td>
												</tr>
												<tr>
													...
													<td style="BORDER-TOP-COLOR: ; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font style="BACKGROUND-COLOR: #e9edf1" size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL25" xd:binding="my:Core/my:Department" xd:disableEditing="yes" style="WHITE-SPACE: nowrap; WIDTH: 342px">
										...
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 696px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 34px">
													<td colSpan="3" style="BORDER-BOTTOM: #000000 1pt solid; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px; BACKGROUND-COLOR: #0070c0">
														<div align="center">
															<font color="#ffffff" size="4" face="Calibri">
												...
												<tr>
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font size="2" face="Calibri">Add Related Document Path:</font>
														</div>
													</td>
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" contentEditable="true" tabIndex="0" xd:xctname="PlainText" xd:CtrlId="CTRL6" xd:binding="my:Core/my:RelatedDocumentSection/my:RDPath" style="WHITE-SPACE: nowrap; WIDTH: 100%">
																	<xsl:value-of select="my:Core/my:RelatedDocumentSection/my:RDPath"/>
																</span>
															</font>
														</div>
													</td>
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div align="center">
															<font size="2" face="Calibri"><input title="" class="langFont" style="PADDING-LEFT: 1px; MARGIN: 1px; PADDING-RIGHT: 1px; WIDTH: 100px" type="button" value="Add" xd:xctname="Button" xd:CtrlId="btn_AddRDPath" tabIndex="0"/>
															</font>
														</div>
													</td>
												</tr>
												<tr>
													<td colSpan="3" style="BORDER-TOP-COLOR: ; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="center"><xsl:apply-templates select="my:Core/my:RelatedDocumentSection" mode="_7"/>
														</div>
													</td>
												</tr>
											</tbody>
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 26px">
													<td style="BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="right">
															<font size="2" face="Calibri"><input title="" class="langFont" style="MARGIN: 1px; WIDTH: 125px" type="button" value="Remove Selection" xd:xctname="Button" xd:CtrlId="btn_InitiateRemoveRD" tabIndex="0">
																	<xsl:attribute name="style">MARGIN: 1px; WIDTH: 125px;<xsl:choose>
																			<xsl:when test="count(my:Core/my:RelatedDocumentSection/my:RelatedDocumentGroup) = 0">DISPLAY: none; caption: Hide if no document path</xsl:when>
																		</xsl:choose>
																	</xsl:attribute>
																</input> <input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Close" xd:xctname="Button" xd:CtrlId="btn_Close" tabIndex="0"/>
															</font>
														</div>
													</td>
												</tr>
	...
	<xsl:template match="my:PlannedTrainingSection" mode="_5">
		<xsl:if test="not((not(contains(../my:RequestType, &quot;Training Request&quot;))))">
			<div title="" class="xdSection xdRepeating" style="BORDER-TOP: 0pt; BORDER-RIGHT: 0pt; BORDER-BOTTOM: 0pt; MARGIN: 0px; BORDER-LEFT: 0pt; WIDTH: 100%" align="left" xd:xctname="Section" xd:CtrlId="CTRL26" tabIndex="-1" xd:widgetIndex="0" xd:caption_0="Hide if not Training Request">
				<div>
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 694px" borderColor="buttontext" border="1">
						...
						<tbody vAlign="top">
							<tr style="MIN-HEIGHT: 24px">
								...
								<td>
									<div>
										<font size="2" face="Calibri"><input title="" class="xdBehavior_Boolean" type="checkbox" value="" tabIndex="0" xd:xctname="CheckBox" xd:CtrlId="CTRL27" xd:binding="my:PlannedTraining" xd:offValue="FALSE" xd:onValue="TRUE" xd:boundProp="xd:value">
	...
	<xsl:template match="my:RelatedDocumentSection" mode="_7">
		<xsl:if test="not((count(my:RelatedDocumentGroup) = 0))">
			<div title="" class="xdSection xdRepeating" style="MARGIN-BOTTOM: 0px; BORDER-TOP: #000000 1pt; BORDER-RIGHT: #000000 1pt; BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: #000000 1pt; WIDTH: 100%" align="left" xd:xctname="Section" xd:CtrlId="CTRL15" tabIndex="-1" xd:widgetIndex="0" xd:caption_0="Hide if no path supplied">
				<div align="center">
					<table title="" class="xdRepeatingTable msoUcTable" style="BORDER-TOP-STYLE: none; WORD-WRAP: break-word; BORDER-LEFT-STYLE: none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; WIDTH: 461px" border="1" xd:CtrlId="CTRL16" xd:widgetIndex="0">
						<colgroup>
						...
						<tbody class="xdTableHeader">
							...
							<xsl:for-each select="my:RelatedDocumentGroup">
								<tr>
									<td style="BORDER-TOP: #d8d8d8 1pt solid; BORDER-RIGHT: #d8d8d8 1pt solid; BORDER-BOTTOM: #d8d8d8 1pt solid; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 5px; BORDER-LEFT: #d8d8d8 1pt solid; PADDING-RIGHT: 5px">
										<div align="left">
											<span title="" class="xdHyperlink" hideFocus="1" style="OVERFLOW: visible; TEXT-ALIGN: left; WIDTH: 384px" xd:xctname="hyperlink">
												<a class="xdDataBindingUI" xd:CtrlId="CTRL19" xd:disableEditing="yes">
													<xsl:attribute name="href">
														<xsl:value-of select="my:RelatedDocumentHyperlink"/>
													</xsl:attribute>
													<xsl:value-of select="my:RelatedDocumentPath"/>
												</a>
											</span>
										</div>
									</td>
									<td style="BORDER-TOP: #d8d8d8 1pt solid; BORDER-RIGHT: #d8d8d8 1pt solid; BORDER-BOTTOM: #d8d8d8 1pt solid; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 5px; BORDER-LEFT: #d8d8d8 1pt solid; PADDING-RIGHT: 5px">
										<div align="center"><input title="" class="xdBehavior_Boolean" type="checkbox" value="" tabIndex="0" xd:xctname="CheckBox" xd:CtrlId="CTRL20" xd:binding="my:RelatedDocumentRemove" xd:offValue="FALSE" xd:onValue="TRUE" xd:boundProp="xd:value" xd:postbackModel="never">
												<xsl:attribute name="xd:value">
													<xsl:value-of select="my:RelatedDocumentRemove"/>
												</xsl:attribute>
												<xsl:if test="my:RelatedDocumentRemove=&quot;TRUE&quot;">
													<xsl:attribute name="CHECKED">CHECKED</xsl:attribute>
												</xsl:if>
											</input>
										</div>
