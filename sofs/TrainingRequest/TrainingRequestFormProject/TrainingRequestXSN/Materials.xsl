...
BODY {
					...
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 600px" borderColor="buttontext" border="1">
						...
						<tbody vAlign="top">
							<tr>
								...
								<td>
									<div>
										<font size="2" face="Calibri"><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #002060" type="button" value="Related Notes" xd:CtrlId="btn_RelatedNotesView" xd:xctname="Button" tabIndex="0"/>
										</font>
									</div>
								</td>
								<td style="PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px; BORDER-LEFT-COLOR: ">
									<div>
										<font size="2" face="Calibri"><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #0070c0" type="button" value="Upload Materials" xd:CtrlId="btn_MaterialsView" xd:xctname="Button" tabIndex="0">
									...
									<div align="left">
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 696px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												...
												<tr>
													<td style="BORDER-TOP-COLOR: ; VERTICAL-ALIGN: top; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<font size="2" face="Calibri">
															<div align="center"><span class="xdFileAttachment" hideFocus="1" style="HEIGHT: 30px; WIDTH: 161px" tabIndex="0" xd:CtrlId="CTRL2" xd:xctname="FileAttachment" xd:binding="my:Core/my:TrainingAttachments/my:TrainingAttachmentObj" xd:boundProp="xd:inline" tabStop="true">
																	<xsl:if test="function-available('xdImage:getImageUrl')">
																		<xsl:attribute name="src"><xsl:value-of select="xdImage:getImageUrl(my:Core/my:TrainingAttachments/my:TrainingAttachmentObj)"/></xsl:attribute>
																	</xsl:if>
																</span><input title="" class="langFont" style="MARGIN: 1px" type="button" value="Upload Material" xd:CtrlId="btn_UploadMaterial" xd:xctname="Button" tabIndex="0"/>
															</div>
															<div align="center"> </div>
															<div align="center"><xsl:apply-templates select="my:Core/my:TrainingAttachments/my:TrainingAttachmentSection" mode="_3"/>
															</div>
														</font>
													</td>
												</tr>
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 26px">
													<td style="BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="right">
															<font size="2" face="Calibri">
																<font size="2" face="Calibri"><input title="" class="langFont" style="MARGIN: 1px; WIDTH: 125px" type="button" value="Remove Selection" xd:CtrlId="btn_InitiateRemoveMaterials" xd:xctname="Button" tabIndex="0">
																		<xsl:attribute name="style">MARGIN: 1px; WIDTH: 125px;<xsl:choose>
																				<xsl:when test="not(starts-with(my:Core/my:TrainingAttachments/my:TrainingAttachmentSection/my:TrainingAttachmentGroup/my:TrainingAttachmentURL, &quot;http&quot;))">DISPLAY: none; caption: Hide if no attachments</xsl:when>
																			</xsl:choose>
																		</xsl:attribute>
																	</input>
																</font>
															</font>
															<font size="2" face="Calibri"> <input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Close" xd:CtrlId="btn_Close" xd:xctname="Button" tabIndex="0"/>
															</font>
														</div>
													</td>
												</tr>
	...
	<xsl:template match="my:TrainingAttachmentSection" mode="_3">
		<xsl:if test="not((not(starts-with(my:TrainingAttachmentGroup/my:TrainingAttachmentURL, &quot;http&quot;))))">
			<div title="" class="xdSection xdRepeating" style="MARGIN-BOTTOM: 0px; BORDER-TOP: 0pt; BORDER-RIGHT: 0pt; BORDER-BOTTOM: 0pt; BORDER-LEFT: 0pt; WIDTH: 100%" align="left" xd:CtrlId="CTRL4" xd:xctname="Section" tabIndex="-1" xd:widgetIndex="0" xd:caption_0="Hide if no attachment found">
				<div align="center">
							...
							<xsl:for-each select="my:TrainingAttachmentGroup">
								<tr>
									<td style="BORDER-TOP: #d8d8d8 1pt solid; BORDER-RIGHT: #d8d8d8 1pt solid; BORDER-BOTTOM: #d8d8d8 1pt solid; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 5px; BORDER-LEFT: #d8d8d8 1pt solid; PADDING-RIGHT: 5px">
										<div align="left">
											<span title="" class="xdHyperlink" hideFocus="1" style="OVERFLOW: visible; TEXT-ALIGN: left; WIDTH: 364px" xd:xctname="hyperlink">
									...
									<td style="BORDER-TOP: #d8d8d8 1pt solid; BORDER-RIGHT: #d8d8d8 1pt solid; BORDER-BOTTOM: #d8d8d8 1pt solid; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 5px; BORDER-LEFT: #d8d8d8 1pt solid; PADDING-RIGHT: 5px">
										<div align="left"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:CtrlId="CTRL5" xd:xctname="PlainText" xd:disableEditing="yes" xd:binding="my:TrainingAttachmentVersion" style="BORDER-TOP: #dcdcdc 1pt; BORDER-RIGHT: #dcdcdc 1pt; WHITE-SPACE: nowrap; BORDER-BOTTOM: #dcdcdc 1pt; BORDER-LEFT: #dcdcdc 1pt; WIDTH: 100%; BACKGROUND-COLOR: transparent">
												<xsl:value-of select="my:TrainingAttachmentVersion"/>
											</span>
										</div>
									</td>
									<td style="BORDER-TOP: #d8d8d8 1pt solid; BORDER-RIGHT: #d8d8d8 1pt solid; BORDER-BOTTOM: #d8d8d8 1pt solid; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 5px; BORDER-LEFT: #d8d8d8 1pt solid; PADDING-RIGHT: 5px">
										<div align="center"><input title="" class="xdBehavior_Boolean" type="checkbox" value="" tabIndex="0" xd:CtrlId="CTRL17" xd:xctname="CheckBox" xd:binding="my:TrainingAttachmentRemove" xd:boundProp="xd:value" xd:onValue="TRUE" xd:offValue="FALSE">
												<xsl:attribute name="xd:value">
													<xsl:value-of select="my:TrainingAttachmentRemove"/>
												</xsl:attribute>
												<xsl:if test="my:TrainingAttachmentRemove=&quot;TRUE&quot;">
													<xsl:attribute name="CHECKED">CHECKED</xsl:attribute>
												</xsl:if>
											</input>
										</div>
