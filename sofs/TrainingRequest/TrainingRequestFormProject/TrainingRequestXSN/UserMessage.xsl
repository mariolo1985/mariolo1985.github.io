			...
			<body>
				...
				<div>
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 700px" borderColor="buttontext" border="1">
						...
						<tbody vAlign="top">
							<tr>
								<td style="BORDER-TOP: #000000 1pt solid; BORDER-RIGHT: #000000 1pt solid; BORDER-BOTTOM: #000000 1pt; BORDER-LEFT: #000000 1pt solid; BACKGROUND-COLOR: #ffffff">
							...
							<tr>
								<td style="BORDER-TOP: #000000 1pt; BORDER-RIGHT: #000000 1pt solid; BORDER-BOTTOM: #000000 1pt solid; BORDER-LEFT: #000000 1pt solid; BACKGROUND-COLOR: #f2f2f2">
									<div>
									...
									<div>
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 697px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												...
												<tr>
													<td style="BORDER-TOP: #000000 1pt solid; BORDER-BOTTOM: #000000 1pt; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px; BACKGROUND-COLOR: transparent"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL1" xd:binding="my:SystemInternal/my:UserMessage" xd:disableEditing="yes" xd:datafmt="&quot;string&quot;,&quot;plainMultiline&quot;" style="WORD-WRAP: break-word; BORDER-TOP: #dcdcdc 1pt; BORDER-RIGHT: #dcdcdc 1pt; WHITE-SPACE: normal; OVERFLOW-X: auto; OVERFLOW-Y: auto; BORDER-BOTTOM: #dcdcdc 1pt; FONT-WEIGHT: bold; BORDER-LEFT: #dcdcdc 1pt; WIDTH: 100%; BACKGROUND-COLOR: transparent">
															<xsl:choose>
																<xsl:when test="function-available('xdFormatting:formatString')">
																	<xsl:value-of select="xdFormatting:formatString(my:SystemInternal/my:UserMessage,&quot;string&quot;,&quot;plainMultiline&quot;)" disable-output-escaping="yes"/>
																</xsl:when>
																<xsl:otherwise>
																	<xsl:value-of select="my:SystemInternal/my:UserMessage" disable-output-escaping="yes"/>
																</xsl:otherwise>
															</xsl:choose>
														</span>
													</td>
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 26px">
													<td style="BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="right">
															<font size="2" face="Calibri"><input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Return" xd:xctname="Button" xd:CtrlId="btn_ReturnToPrevious" tabIndex="0">
																	<xsl:attribute name="style">MARGIN: 1px; WIDTH: 100px;<xsl:choose>
																			<xsl:when test="my:SystemInternal/my:HideReturnBtn = &quot;TRUE&quot;">DISPLAY: none; caption: Hide</xsl:when>
																		</xsl:choose>
																	</xsl:attribute>
