...
BODY {
	COLOR: black
			...
			<body>
				<div>
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 150px" borderColor="buttontext" border="1">
						<colgroup>
								...
								<td style="BACKGROUND-COLOR: transparent">
									<div align="center">
										<font color="#ffffff" size="2" face="Calibri">
											<strong><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #0070c0" type="button" value="Core Information" xd:xctname="Button" xd:CtrlId="btn_CoreInfoView" tabIndex="0">
											...
											<tbody vAlign="top">
												...
												<tr>
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font size="2" face="Calibri">Request Title: <font color="#ff0000">*</font>
															</font>
														</div>
													</td>
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font style="BACKGROUND-COLOR: #e9edf1" size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="0" xd:xctname="PlainText" xd:CtrlId="CTRL1" xd:binding="my:Core/my:RequestTitle" xd:datafmt="&quot;string&quot;,&quot;plainMultiline&quot;" style="WORD-WRAP: break-word; WHITE-SPACE: normal; OVERFLOW-X: auto; OVERFLOW-Y: auto; WIDTH: 100%">
																	<xsl:choose>
												...
												<tr>
													<td style="PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>Request Type: <font color="#ff0000">*</font>
														</div>
													</td>
													<td style="PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font style="BACKGROUND-COLOR: #e9edf1" size="2" face="Calibri">
																<select title="" class="xdComboBox xdBehavior_Select" style="WIDTH: 344px" size="1" xd:xctname="dropdown" xd:CtrlId="CTRL28" xd:binding="my:Core/my:RequestType" value="" xd:boundProp="value" tabIndex="0">
																	...
																	<xsl:choose>
																		<xsl:when test="function-available('xdXDocument:GetDOM')">
																			<option/>
																			<xsl:variable name="val" select="my:Core/my:RequestType"/>
																			<xsl:if test="not(my:FieldSouce/my:RequestTypeSection/my:RequestTypeGroup/my:RequestTypeValue[.=$val] or $val='')">
																			...
																			<xsl:variable name="items">
																				<xsl:copy-of select="my:FieldSouce/my:RequestTypeSection/my:RequestTypeGroup/my:RequestTypeValue"/>
																			</xsl:variable>
																			<xsl:variable name="uniqueItems" select="msxsl:node-set($items)/*[not(. = preceding::my:RequestTypeValue)]"/>
												...
												<tr>
													<td style="BORDER-TOP-COLOR: ; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>Department: <font color="#ff0000">*</font>
														</div>
													</td>
													<td style="BORDER-TOP-COLOR: ; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font style="BACKGROUND-COLOR: #e9edf1" size="2" face="Calibri">
																<select title="" class="xdComboBox xdBehavior_Select" style="WIDTH: 344px" size="1" xd:xctname="dropdown" xd:CtrlId="CTRL29" xd:binding="my:Core/my:Department" value="" xd:boundProp="value" tabIndex="0">
																	<xsl:attribute name="value">
																	...
																	<xsl:choose>
																		<xsl:when test="function-available('xdXDocument:GetDOM')">
																			<option/>
																			<xsl:variable name="val" select="my:Core/my:Department"/>
																			<xsl:if test="not(my:FieldSouce/my:DepartmentSection/my:DepartmentGroup/my:DepartmentValue[.=$val] or $val='')">
																				<option selected="selected">
																					<xsl:attribute name="value">
																						<xsl:value-of select="$val"/>
																					</xsl:attribute>
																			...
																			<xsl:variable name="items">
																				<xsl:copy-of select="my:FieldSouce/my:DepartmentSection/my:DepartmentGroup/my:DepartmentValue"/>
																			</xsl:variable>
																			<xsl:variable name="uniqueItems" select="msxsl:node-set($items)/*[not(. = preceding::my:DepartmentValue)]"/>
																			<xsl:for-each select="$uniqueItems">
																				<option>
																					<xsl:attribute name="value">
																						<xsl:value-of select="."/>
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 26px">
													<td style="BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="right">
															<font size="2" face="Calibri"><input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Request" xd:xctname="Button" xd:CtrlId="btn_SubmitRequest" tabIndex="0"/> <input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Close" xd:xctname="Button" xd:CtrlId="btn_Close" tabIndex="0"/>
															</font>
														</div>
													</td>
												</tr>
					...
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 694px" borderColor="buttontext" border="1">
						...
						<tbody vAlign="top">
							<tr style="MIN-HEIGHT: 24px">
								...
								<td>
									<div>
										<font size="2" face="Calibri"><input title="" class="xdBehavior_Boolean" type="checkbox" value="" tabIndex="0" xd:xctname="CheckBox" xd:CtrlId="CTRL27" xd:binding="my:PlannedTraining" xd:boundProp="xd:value" xd:offValue="FALSE" xd:onValue="TRUE">
