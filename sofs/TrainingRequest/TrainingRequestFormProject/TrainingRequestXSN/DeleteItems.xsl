											...
											<tbody vAlign="top">
												<tr>
													...
													<td style="BORDER-TOP-COLOR: ; BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div>
															<font size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL2" xd:binding="my:FormInternal/my:LifecycleStatus" xd:disableEditing="yes" style="BORDER-TOP: #dcdcdc 1pt; BORDER-RIGHT: #dcdcdc 1pt; WHITE-SPACE: nowrap; BORDER-BOTTOM: #dcdcdc 1pt; TEXT-ALIGN: right; BORDER-LEFT: #dcdcdc 1pt; WIDTH: 100%; BACKGROUND-COLOR: transparent">
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 26px">
													<td style="BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="right">
															<font size="2" face="Calibri"><input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Remove" xd:xctname="Button" xd:CtrlId="btn_DeleteItem" tabIndex="0">
																...
																</input> <input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Cancel" xd:xctname="Button" xd:CtrlId="btn_Cancel" tabIndex="0"/>
															</font>
														</div>
													</td>
												</tr>
