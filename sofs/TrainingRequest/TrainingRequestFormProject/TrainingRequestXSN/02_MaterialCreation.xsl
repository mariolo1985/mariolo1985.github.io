					...
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 600px" borderColor="buttontext" border="1">
						...
						<tbody vAlign="top">
							<tr>
								...
								<td>
									<div>
										<font size="2" face="Calibri"><input title="" class="langFont" style="BORDER-TOP: #808080 6pt; BORDER-RIGHT: #808080 6pt; BORDER-BOTTOM: #808080 6pt; FONT-WEIGHT: bold; COLOR: #ffffff; MARGIN: 1px; BORDER-LEFT: #808080 6pt; WIDTH: 100%; BACKGROUND-COLOR: #002060" type="button" value="Related Documents" xd:xctname="Button" xd:CtrlId="btn_RelatedDocumentView" tabIndex="0"/>
										</font>
									</div>
								</td>
								<td>
