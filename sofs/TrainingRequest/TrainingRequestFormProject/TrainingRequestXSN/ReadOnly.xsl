...
BODY {
								...
								<td style="BORDER-TOP: #000000 1pt solid; BORDER-RIGHT: #000000 1pt solid; BORDER-BOTTOM: #000000 1pt solid; BORDER-LEFT: #000000 1pt solid; BACKGROUND-COLOR: #f2f2f2">
											...
											<tbody vAlign="top">
												<tr>
													...
													<td style="BORDER-TOP-COLOR: ; BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div>
															<font size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL8" xd:binding="my:FormInternal/my:LifecycleStatus" xd:disableEditing="yes" style="BORDER-TOP: #dcdcdc 1pt; BORDER-RIGHT: #dcdcdc 1pt; WHITE-SPACE: nowrap; BORDER-BOTTOM: #dcdcdc 1pt; TEXT-ALIGN: right; BORDER-LEFT: #dcdcdc 1pt; WIDTH: 100%; BACKGROUND-COLOR: transparent">
										...
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 697px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												...
												<tr>
													...
													<td style="BORDER-TOP-COLOR: ; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<div>
															<font style="BACKGROUND-COLOR: #e9edf1" size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL2" xd:binding="my:Core/my:Department" xd:disableEditing="yes" style="WHITE-SPACE: nowrap; WIDTH: 342px">
										...
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 696px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 34px">
													<td style="BORDER-BOTTOM: #000000 1pt solid; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px; BACKGROUND-COLOR: #0070c0">
														<div align="center">
															<font color="#ffffff" size="4" face="Calibri">
												...
												<tr>
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 1px; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="center"><xsl:apply-templates select="my:Core/my:RelatedDocumentSection" mode="_5"/>
														</div>
													</td>
												</tr>
											</tbody>
										...
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 697px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												...
												<tr style="MIN-HEIGHT: 27px">
													<td style="BORDER-TOP: #000000 1pt solid; PADDING-BOTTOM: 5px; BORDER-BOTTOM-COLOR: ; PADDING-TOP: 5px; PADDING-LEFT: 0px; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 0px">
														<div><xsl:apply-templates select="my:Core/my:NotesSection" mode="_3"/>
														</div>
													</td>
												</tr>
											</tbody>
									...
									<div>
										<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 696px" borderColor="buttontext" border="1">
											...
											<tbody vAlign="top">
												<tr>
													<td style="PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px; BACKGROUND-COLOR: #0070c0">
														<div align="center">
															<font color="#ffffff" size="4" face="Calibri">
												...
												<tr>
													<td style="BORDER-TOP-COLOR: ; PADDING-BOTTOM: 5px; PADDING-TOP: 5px; PADDING-LEFT: 1px; PADDING-RIGHT: 1px">
														<font size="2" face="Calibri">
															<div align="center"></div>
															<div><xsl:apply-templates select="my:Core/my:TrainingAttachments/my:TrainingAttachmentSection" mode="_6"/>
															</div>
														</font>
													</td>
												</tr>
											...
											<tbody vAlign="top">
												<tr style="MIN-HEIGHT: 26px">
													<td style="BORDER-BOTTOM-COLOR: ; BORDER-RIGHT-COLOR: ; PADDING-RIGHT: 1px">
														<div align="right">
															<font size="2" face="Calibri"> <input title="" class="langFont" style="MARGIN: 1px; WIDTH: 100px" type="button" value="Close" xd:xctname="Button" xd:CtrlId="btn_Close" tabIndex="0"/>
															</font>
														</div>
													</td>
												</tr>
									...
									<div>
										<font size="2" face="Calibri"><input title="" class="xdBehavior_Boolean" type="checkbox" value="" tabIndex="0" xd:xctname="CheckBox" xd:CtrlId="CTRL27" xd:binding="my:PlannedTraining" xd:offValue="FALSE" xd:onValue="TRUE" xd:boundProp="xd:value">
												<xsl:attribute name="style">
													<xsl:choose>
														<xsl:when test="1 = 1">caption: Disable on read only</xsl:when>
													</xsl:choose>
												</xsl:attribute>
												<xsl:choose>
													<xsl:when test="1 = 1">
	...
	<xsl:template match="my:RelatedDocumentSection" mode="_5">
		<xsl:if test="not((count(my:RelatedDocumentGroup) = 0))">
			<div title="" class="xdSection xdRepeating" style="MARGIN-BOTTOM: 0px; BORDER-TOP: 0pt; BORDER-RIGHT: 0pt; BORDER-BOTTOM: 0pt; BORDER-LEFT: 0pt; WIDTH: 100%" align="left" xd:xctname="Section" xd:CtrlId="CTRL4" tabIndex="-1" xd:widgetIndex="0" xd:caption_0="Hide if no path set">
				<div align="center">
					<table title="" class="xdRepeatingTable msoUcTable" style="BORDER-TOP-STYLE: none; WORD-WRAP: break-word; BORDER-LEFT-STYLE: none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; WIDTH: 461px" border="1" xd:CtrlId="CTRL15" xd:widgetIndex="0">
						<colgroup>
							...
							<xsl:for-each select="my:RelatedDocumentGroup">
								<tr>
									<td style="BORDER-TOP: #d8d8d8 1pt solid; BORDER-RIGHT: #d8d8d8 1pt solid; BORDER-BOTTOM: #d8d8d8 1pt solid; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 5px; BORDER-LEFT: #d8d8d8 1pt solid; PADDING-RIGHT: 5px">
										<div align="left">
											<span title="" class="xdHyperlink" hideFocus="1" style="OVERFLOW: visible; HEIGHT: 18px; TEXT-ALIGN: left; WIDTH: 433px" xd:xctname="hyperlink">
	...
	<xsl:template match="my:NotesSection" mode="_3">
		<xsl:if test="not((my:NotesHistory = &quot;&quot;))">
			<div title="" class="xdSection xdRepeating" style="BORDER-TOP: 0pt; BORDER-RIGHT: 0pt; BORDER-BOTTOM: 0pt; MARGIN: 0px; BORDER-LEFT: 0pt; WIDTH: 694px" align="left" xd:xctname="Section" xd:CtrlId="CTRL21" tabIndex="-1" xd:widgetIndex="0" xd:caption_0="Hide if history is empty">
				<div>
					<table class="xdLayout" style="WORD-WRAP: break-word; BORDER-TOP: medium none; BORDER-RIGHT: medium none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM: medium none; BORDER-LEFT: medium none; WIDTH: 693px" borderColor="buttontext" border="1">
						<colgroup>
							<col style="WIDTH: 129px"></col>
							<col style="WIDTH: 564px"></col>
						</colgroup>
						<tbody vAlign="top">
							<tr>
								<td>
								...
								<td>
									<div>
										<font size="2" face="Calibri"><span title="" class="xdTextBox" hideFocus="1" tabIndex="-1" xd:xctname="PlainText" xd:CtrlId="CTRL23" xd:binding="my:NotesHistory" xd:disableEditing="yes" xd:datafmt="&quot;string&quot;,&quot;plainMultiline&quot;" style="WORD-WRAP: break-word; WHITE-SPACE: normal; OVERFLOW-X: auto; OVERFLOW-Y: auto; WIDTH: 100%">
												<xsl:choose>
													<xsl:when test="function-available('xdFormatting:formatString')">
	...
	<xsl:template match="my:TrainingAttachmentSection" mode="_6">
		<xsl:if test="not((not(starts-with(my:TrainingAttachmentGroup/my:TrainingAttachmentURL, &quot;http&quot;))))">
			<div title="" class="xdSection xdRepeating" style="MARGIN-BOTTOM: 0px; BORDER-TOP: 0pt; BORDER-RIGHT: 0pt; BORDER-BOTTOM: 0pt; BORDER-LEFT: 0pt; WIDTH: 689px" align="left" xd:xctname="Section" xd:CtrlId="CTRL5" tabIndex="-1" xd:widgetIndex="0" xd:caption_0="Hide if no attachment found">
				<div align="center">
					<table title="" class="xdRepeatingTable msoUcTable" style="BORDER-TOP-STYLE: none; WORD-WRAP: break-word; BORDER-LEFT-STYLE: none; BORDER-COLLAPSE: collapse; TABLE-LAYOUT: fixed; BORDER-BOTTOM-STYLE: none; BORDER-RIGHT-STYLE: none; WIDTH: 500px" border="1" xd:CtrlId="CTRL7" xd:widgetIndex="0">
						<colgroup>
						...
						<tbody class="xdTableHeader">
							...
							<xsl:for-each select="my:TrainingAttachmentGroup">
								<tr>
									<td style="BORDER-TOP: #d8d8d8 1pt solid; BORDER-RIGHT: #d8d8d8 1pt solid; BORDER-BOTTOM: #d8d8d8 1pt solid; PADDING-BOTTOM: 1px; PADDING-TOP: 1px; PADDING-LEFT: 5px; BORDER-LEFT: #d8d8d8 1pt solid; PADDING-RIGHT: 5px">
										<div align="left">
											<span title="" class="xdHyperlink" hideFocus="1" style="OVERFLOW: visible; TEXT-ALIGN: left; WIDTH: 482px" xd:xctname="hyperlink">
												<a class="xdDataBindingUI" xd:CtrlId="CTRL12" xd:disableEditing="yes">
													<xsl:attribute name="href">
														<xsl:value-of select="my:TrainingAttachmentURL"/>
													</xsl:attribute>
													<xsl:value-of select="my:TrainingAttachmentName"/>
												</a>
											</span>
										</div>
									</td>
